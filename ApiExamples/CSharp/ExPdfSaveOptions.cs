    ...
    internal class ExPdfSaveOptions : ApiExampleBase
    {
        ...
        public void HandleBinaryRasterWarnings()
        {
            ...
            MetafileRenderingOptions metafileRenderingOptions = new MetafileRenderingOptions
            {
                ...
                RenderingMode = MetafileRenderingMode.VectorWithFallback // If Aspose.Words cannot correctly render some of the metafile records to vector graphics then Aspose.Words renders this metafile to a bitmap. 
            };
